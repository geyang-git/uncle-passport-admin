...
<script lang="ts" name="form-form5" setup>
...
const Upsert = useUpsert({
	items: [
		...
		{ label: "媒体组织", prop: "media", required: true, component: { name: "el-input" } },
		{ label: "工作部门", prop: "department", required: true, component: { name: "el-input" } },
		{ label: "职位", prop: "position", required: true, component: { name: "el-input" } },
		{ label: "居住国", prop: "country", required: true, component: { name: "el-input" } },
		{ label: "网站", prop: "website", required: true, component: { name: "el-input" } },
		{
			label: "如何联系",
			prop: "contact",
			component: {
